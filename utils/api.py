...
class Google_maps_api():
    ...
    def get_new_place(place_id):
        get_resource = "/maps/api/place/get/json"  # Ресурс метод Get
    ...
    def put_new_place(place_id):
        put_resource = "/maps/api/place/update/json"  # Ресурс метод Put
    ...
    def delete_new_place(place_id):
        delete_resource = "/maps/api/place/delete/json"  # Ресурс метод delete
